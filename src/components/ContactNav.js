    ...
    return (<section className="flex justify-center p-10 align-middle bg-black">
        <div className="w-full max-w-lg">
            ...
            <div className="flex flex-row justify-between md:z-10  md:w-full px-10 md:px-20 my-2 md:my-5">
                <a href={Resume}><img className="logo" src={ResumeLogo} alt="Resume" /></a>
                <a href="https://www.linkedin.com/in/jacobprudent"><img className="logo" src={LinkedInLogo} alt="LinkedIn" /></a>
                <a href="https://github.com/prudentj"><img className="logo" src={GithubLogo} alt="GitHub" /></a>
                <a href="https://twitter.com/JacobPrudent"><img className="logo" src={TwitterLogo} alt="Twitter" /></a>
